<div>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900 mb-4">{{ __('System Settings') }}</h2>
            ...
            <div class="mb-4">
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        <button wire:click="setActiveTab('organization')" class="py-4 px-1 {{ $activeTab === 'organization' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap font-medium text-sm border-b-2">
                            {{ __('Organization') }}
                        </button>
                        <button wire:click="setActiveTab('payment')" class="py-4 px-1 {{ $activeTab === 'payment' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap font-medium text-sm border-b-2">
                            {{ __('Payment') }}
                        </button>
                        <button wire:click="setActiveTab('notification')" class="py-4 px-1 {{ $activeTab === 'notification' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap font-medium text-sm border-b-2">
                            {{ __('Notification') }}
                        </button>
                        <button wire:click="setActiveTab('system')" class="py-4 px-1 {{ $activeTab === 'system' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap font-medium text-sm border-b-2">
                            {{ __('System') }}
                        </button>
                    </nav>
                </div>
