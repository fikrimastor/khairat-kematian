            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="mb-4">
                    ...
                    @if($calculatedAmount > 0)
                        <p class="text-sm text-gray-600 mt-1">{{ __('Calculated amount based on your membership type: RM') }} {{ number_format($calculatedAmount, 2) }}</p>
                    @endif
                </div>
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="reference" type="text" class="mt-1 block w-full" wire:model="reference" placeholder="{{ __('Optional reference for this payment') }}" />
                ...
                @if($showSummary)
                    <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                        <h3 class="text-md font-medium text-gray-900 mb-2">{{ __('Payment Summary') }}</h3>
                        <div class="space-y-2">
    ...
    @if($showProcessingModal)
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
                <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('Processing Payment') }}</h3>
                ...
                <p class="text-center text-gray-600">{{ __('Please wait while we process your payment...') }}</p>
            </div>
        </div>
    @endif
</div> 